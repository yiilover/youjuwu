...
class usercontrol extends base {
    ...
    function onuploadavatar2() {
        ...
        @copy($_FILES['Filedata']['tmp_name'], $bigavatarfile);
        @copy($_FILES['Filedata']['tmp_name'], $middleavatarfile);
        @copy($_FILES['Filedata']['tmp_name'], $smallavatarfile);
        $success = 1;
